...
{
    /// <inheritdoc />
    public partial class enameTaskStatusToFarmTaskStatus : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "Email", "HireDate", "IsActive", "Name", "Phone", "Position" },
                values: new object[,]
                {
                    { 1, "john.doe@inyamayethu.co.za", new DateTime(2023, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "John Doe", "072-123-4567", "Farm Worker" },
                    { 2, "jane.smith@inyamayethu.co.za", new DateTime(2022, 8, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Jane Smith", "073-987-6543", "Farm Manager" }
                });
